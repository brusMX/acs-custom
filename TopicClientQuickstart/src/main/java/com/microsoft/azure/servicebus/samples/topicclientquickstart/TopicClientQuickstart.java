...
public class TopicClientQuickstart {
    ...
    private static String connectionString = System.getenv("SOURCE_TOPIC_CONNECTIONSTRING");
    private static String topicName = System.getenv("SOURCE_TOPICNAME");
    private static String subscriptionName = System.getenv("SOURCE_SUBSCRIPTIONNAME");

    private static ITopicClient topicClient;
    private static ISubscriptionClient subscriptionClient;
    private static int totalSend = 10000;
    ...
    public static void main(String[] args) throws Exception {
        ...
        ConnectionStringBuilder sendConnectionString = new ConnectionStringBuilder(
            System.getenv("TARGET_TOPIC_CONNECTIONSTRING"),System.getenv("TARGET_TOPIC_NAME"));

             
        IMessageSender sender= ClientFactory.createMessageSenderFromConnectionStringBuilder(sendConnectionString);
